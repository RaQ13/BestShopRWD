...
function watcher(done) {
    ...
    gulp.watch(entryPath + "/elements/**/*.scss", gulp.series(compileSass, reload));
    gulp.watch(entryPath + "/generic/**/*.scss", gulp.series(compileSass, reload));
    gulp.watch(entryPath + "/settings/**/*.scss", gulp.series(compileSass, reload));
